...
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssssssssssssss", $username, $firstName, $lastName, $phoneNo, $email, $state, $city, $address1, $address2, $dob, $aadharNumber, $aadharPath, $carNumber, $dlNumber, $dlPath);
